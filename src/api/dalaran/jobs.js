...
export default {
    getlogs(params) {
        return http.get('/dalaran/logs',{params: params});
    },
    getMashines() {
        return http.get('/dalaran/mashines');
    },
    getjobs(params) {
        return http.get('/dalaran/jobs', {params: params});
    },
    createjob(params) {
        return http.get('/dalaran/createjob', {params: params});
    },
    startjob(params) {
        return http.get('/dalaran/startjob', {params: params});
    },
    stopjob(params) {
        return http.get('/dalaran/stopjob', {params: params});
    },
    updatejob(params) {
