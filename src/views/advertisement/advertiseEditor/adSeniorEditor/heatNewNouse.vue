<template>
        ...
        <div>           
            <Form ref="seniorForm" :model="share" :rules="ruleValidate" :label-width="100">
                ...
                <!-- <FormItem label="内容关键词">
                    <Select v-model="model11" filterable @on-change="handleAdd" @on-query-change="seachChange">
                        <Option v-for="item in keywordList" :value="item.newcode" :key="item.newcode">{{ item.projName }}</Option>
                    </Select>                            
                </FormItem> -->
                <!-- <div v-if="formisShow">
                    <FormItem label="楼盘名称" prop="projName">
                        <Input v-model="share.projName" placeholder="Enter something..." readonly></Input>
                    </FormItem>
                </div> -->
                <!-- <FormItem label="小区总价">
                    <Input v-model="share.totalPrice" placeholder="Enter something..." readonly></Input>
                </FormItem>
                <FormItem label="建筑面积">
                    <Input v-model="share.purposearea" placeholder="Enter something..." readonly></Input>
                </FormItem>
                <FormItem label="年限">
                    <Input v-model="share.rightYear" placeholder="Enter something..." readonly></Input>
                </FormItem>
                <FormItem label="区域名称">
                    <Input v-model="share.districtName" placeholder="Enter something..." readonly></Input>
                </FormItem>
                <FormItem label="标题图">
                    <Input v-model="share.titleImagePath" placeholder="Enter something..." readonly></Input>
                </FormItem> -->
            </Form>
        </div>
        </Col>
    ...
    <!-- <div class="list-item">
            <div class="title-img" style="position: relative;float: left;width: 100px;height: 80px;overflow: hidden;">
                <img style="width:100%" src="http://s1.qn.toutiaofangchan.com/5ac2f95e-e7df-11e7-bd2e-14abc5f0dc77.jpg-dongfangdi400x300"> 
                <p  style="position: absolute;bottom: 0;">
                    <span  style="display: inline-block; padding: 5px 5px;margin-right: 5px;line-height: 1;text-align: center;color: #fff; border-radius: 10px;font-size: 10px; background-color: #924548;" >别墅</span>
                    <span style="display: inline-block; padding: 5px 5px;margin-right: 5px;line-height: 1;text-align: center;color: #fff; border-radius: 10px;font-size: 10px; background: rgb(190, 154, 70);" >在售</span>
                </p>
            </div>
            <div class="title-content" style="position: absolute;left: 0; width: 100%;height: 80px;padding-left: 110px;-webkit-box-sizing: border-box; box-sizing: border-box;">
                ...
                <div class="price-set" style="position: absolute;top: 41%;">
                    <div class="title-price" style="display: inline-block;color: #ff4848;">
                        ...
                        <em style="margin-left: 10px;font-size: 12px;display: inline-block;vertical-align: top;">万</em>
                    </div>
                </div> 
            <div class="piece-bottom" style="position: absolute;left: 0;bottom: -20px;color: #666; width: 100%;padding-bottom: 10px;padding-left: 100px; -webkit-box-sizing: border-box;box-sizing: border-box;overflow: hidden;-o-text-overflow: ellipsis;text-overflow: ellipsis;white-space: nowrap;font-size: 12px;">
    ...
    export default {
        ...
        methods: {
            ...
            api.getProjDetail({
               ...
               // console.log(item);
                // this.share.projName = "某某楼盘"
                // this.share.totalPrice = '500';
                // this.share.purposearea = '352-397㎡';
                // this.share.rightYear = '2017/3/31';
                // this.share.districtName = '昌平 六环';
                // this.share.titleImagePath = 'http://s1.qn.toutiaofangchan.com/215c9200-e7d3-11e7-963b-14abc5f0dc77.jpg-dongfangdi400x300';
                // this.keyShow = false;
            },
        },
       watch:{
