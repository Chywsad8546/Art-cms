      ...
      <TabPane label="内容">
       <Form ref="formValidate" :model="share" :label-width="80">
        <Row class="navdhName">
         ...
         <Col span="24">
         <h3>楼龄</h3>
            <RadioGroup v-model="share.houseYear" type="button" size="small" @on-change="areaChange">
...
export default {
    ...
    created: function () {
        ...
        api.getCityAllInfo({cityDomain:"bj"}).then(response=>{
            ...
            this.share.searchCondition = response.data.cityAllInfos.searchConditionData.community;
