<template>
    <div>
        ...
        <Upload id="iviewUp" :action="$domain.uploadNewsFile" :on-success="successPreview" v-show="uploadFlag">
            <i-button type="ghost" icon="ios-cloud-upload-outline">上传文件</i-button>
        </Upload>
        <Upload id="iviewUp2" :action="$domain.uploadNewsFile" :on-success="successPreviewTrue" v-show="uploadFlag">
            <i-button type="ghost" icon="ios-cloud-upload-outline">上传文件</i-button>
        </Upload>
