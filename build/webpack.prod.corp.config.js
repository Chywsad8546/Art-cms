...
fs.open('./build/configdir/domain/domain.js', 'w', function(err, fd) {
    const buf = 'import domain from \'./domain.pro\';\n' +
        'export default domain;\n';
    fs.write(fd, buf, 0, buf.length, 0, function(err, written, buffer) {});
});
fs.open('./build/env.js', 'w', function(err, fd) {
    const buf = 'export const errortip  = false;export const xiangmu = "kefu";export default "production";export const qufencity = 0;';
    fs.write(fd, buf, 0, buf.length, 0, function(err, written, buffer) {});
});
